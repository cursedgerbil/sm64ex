...
void newcam_init(struct Camera *c, u8 dv) {
    ...
    switch (gCurrLevelNum) {
        case LEVEL_BITDW: newcam_yaw = 0x4000; newcam_tilt = 4000; newcam_distance_target = newcam_distance_values[2]; break;
        case LEVEL_BITFS: newcam_yaw = 0x4000; newcam_tilt = 4000; newcam_distance_target = newcam_distance_values[2]; break;
        case LEVEL_BITS: newcam_yaw = 0x4000; newcam_tilt = 4000; newcam_distance_target = newcam_distance_values[2]; break;
