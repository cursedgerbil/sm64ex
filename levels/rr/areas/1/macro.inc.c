...
const MacroObject rr_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_coin_ring_horizontal_flying,        /*yaw*/   0, /*pos*/  -7000,  4650, -8101),
    MACRO_OBJECT(/*preset*/ macro_coin_ring_horizontal_flying,        /*yaw*/   0, /*pos*/  -5800,  4950, -8101),
