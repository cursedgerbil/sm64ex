...
const MacroObject hmc_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_scuttlebug,                  /*yaw*/   0, /*pos*/ -3533,  1851, -6340),
    ...
    MACRO_OBJECT(/*preset*/ macro_coin_ring_horizontal,        /*yaw*/   0, /*pos*/ -4370,  2660, -2243),
    MACRO_OBJECT(/*preset*/ macro_coin_ring_horizontal,        /*yaw*/   0, /*pos*/  1100,   520,  5950),
